...
const imagesEl = ({ url, alt }) => {
  return `<li class = "imgGallery"><img class = "pictures" src="${url}" alt = "${alt}"></li>`;
}

const picturesEl = images.map(imagesEl).join('');
// console.log(picturesEl);

imageEl.insertAdjacentHTML("afterbegin", picturesEl);
console.log(imageEl);
